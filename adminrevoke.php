...
if (isset($_GET['revokeregistereduser'])){
    
    $validate_user_id=$_GET['revokeregistereduser'];
    
    $validate_registered_user = "UPDATE `Users` SET `authorised`=0 WHERE user_id='$validate_user_id'";
