    ...
    <body>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-sm">
                ...
                $venuemanagermessages = "SELECT * FROM Messages INNER JOIN Users ON Messages.sender_id=Users.user_id WHERE Messages.recieved_id='$venuemanagerid'";

                $result = $conn->query($venuemanagermessages);
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <th>$senderphone</th>
                            ...
                            <td><a href='venuemanagerreplytouser.php?userreplyid=$sender_id'>Reply</a></td>
