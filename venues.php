    ...
    <div class="card-deck">
        ...
        <?php
            while ($row = $result->fetch_assoc ()) {
                ...
                $venuebio = $row["bio"];
                $venuelocation = $row["location"];
                $venueseatcapacity = $row["seatcapacity"];
                 $venueimage= $row["venueimage"];


                echo "<div class = 'col-md-4'>
                    <div class='card'>
  <img src='uploaded/$venueimage'class='card-img-top' alt='...'>
  <div class='card-body'>
    <h5 class='card-title'>$venuename</h5>
    <p class='card-text'>$venuebio</p>
    <p class='card-text'><small class='text-muted'>$venuelocation</small></p>
        <a href='viewvenueinformation.php?rowid=$venue' <button type='button' class='btn btn-primary btn-lg btn-block'>View Venue Information</button></a>
  </div>
</div>
</div>
                   ";
