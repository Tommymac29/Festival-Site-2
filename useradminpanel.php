                ...
                <div class="row">
                    <nav class="col-md-2 d-none d-md-block bg-light sidebar">
                        <div class="sidebar-sticky">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link active" href="useradminpanel.php?accountinformation">
                                        <span data-feather="home"></span>
                                        Account Information <span class="sr-only">(current)</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="useradminpanel.php?bookings">
                                        <span data-feather="file"></span>
                                       Bookings
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="useradminpanel.php?reviews">
                                        <span data-feather="shopping-cart"></span>
                                        Reviews
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="useradminpanel.php?announcements">
                                        <span data-feather="file"></span>
                                       Announcements
                                    </a>
                                </li>
                                 <li class="nav-item">
                                    <a class="nav-link" href="useradminpanel.php?contact">
                                        <span data-feather="file"></span>
                                       Contact Venue Manager
                                    </a>
                                </li>
                                 <li class="nav-item">
                                    <a class="nav-link" href="useradminpanel.php?venuemanagerreplies">
                                        <span data-feather="file"></span>
                                       User Inbox
                                    </a>
                                </li>
                    ...
                    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                        ...
                        if (isset($_GET['announcements'])) {
                            include ('useraccountannouncements.php');
                        }
                         if (isset($_GET['contact'])) {
                            include ('usercontactvenuemanager.php');
                        }
                        if (isset($_GET['venuemanagerreplies'])) {
                            include ('uservenuemanagermessages.php');
                        }
