...
if (isset($_GET['removevenue'])){
    
    $removevenue_id=$_GET['removevenue'];
    
    $remove_manager_venue = "DELETE FROM Venue WHERE venue_id='$removevenue_id'";
    
    $run_delete= mysqli_query($conn,$remove_manager_venue);
