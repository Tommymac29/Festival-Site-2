...
<html>
    ...
    <body>
        <?php
        if (isset($_GET['adminremoveperformance'])){
    
    $remove_performance_id=$_GET['adminremoveperformance'];
    
    $remove_performance = "DELETE FROM Performance WHERE performance_id='$remove_performance_id'";
    
    $run_delete= mysqli_query($conn,$remove_performance);
