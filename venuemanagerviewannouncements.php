...
<html>
    ...
    <body>
        <div class="col-md-8 order-md-1">
            <h4 class="mb-3">ALL EVENT ANNOUNCEMENTS</h4>
                ...
                echo "<thead>
                    <tr>
                        ...
                        <th>$announcement_time</th>
                            ...
                            <td><a href='venuemanagerremoveannouncement.php?venuemanagerremoveannouncement=$announcement_id'>Remove Announcement</a></td>
