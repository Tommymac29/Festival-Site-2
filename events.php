...
<html>
    ...
    <body>
        ...
        $eventsresult = $conn->query($allevents);
    ...
    <div class='card-body'>
      ...
      <p class='card-text'><small class='text-muted'>$eventtime</small></p>
            <a href='vieweventinformation.php?rowid=$events' <button type='button' class='btn btn-primary btn-lg btn-block'>View Event Information</button></a>
